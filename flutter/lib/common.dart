...
final Map<WindowKey, LastWindowPosition> _saveWindowData = Map<WindowKey, LastWindowPosition>();
...
Future<void> saveWindowPosition(WindowType type, {int? windowId, bool? flush}) async {
  ...
  final existingPos = _saveWindowData[key];

  if ((existingPos == null) || !pos.equals(existingPos)) {
    _saveWindowData[key] = pos;
...
Future<void> _saveWindowPositionActual(WindowKey key) async {
  LastWindowPosition? pos = _saveWindowData[key];
